...
import (
	...
	"github.com/Eomaxl/VideoConferenceAndLiveStreaming/internal/handlers"
	w "github.com/Eomaxl/VideoConferenceAndLiveStreaming/pkg/webrtc"
...
var (
	addr = flag.String("addr", os.Getenv("PORT"), "server addresss")
